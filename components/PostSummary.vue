  ...
  <div class="news-post">
    ...
    <div class="news-content">
      ...
      <div class="title">
        ...
        <template v-else>
          <nuxt-link :to="'/post/' + post._id">{{ post.title.rendered | decodeString }}</nuxt-link>
        </template>
      </div>

      <div class="meta">
        <!-- <span v-if="post.type !== 'job'" class="by">
          by <nuxt-link :to="'/user/' + post.by">{{ post.by }}</nuxt-link>
        </span> -->
        <span class="time">
        ...
        | <nuxt-link :to="'/post/' + post._id">{{ post.descendants }} comments</nuxt-link>
      </span> -->
      </div>
