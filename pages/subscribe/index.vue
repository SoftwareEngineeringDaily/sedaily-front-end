    ...
    <div class="row text-center">
      <div class="col-md-offset-2 col-md-6 text-center">
        ...
        <button
          ...
          @click="signUpForSubscriptionMonthly"> Get Started </button>
      </div>
      ...
      <div class="col-md-5 text-center yearly-plan">
        ...
        <button
          class="yearly-button"
          @click="signUpForSubscriptionYearly"> Get Started </button>
      </div>
    </div>
    ...
    <div class="row faq">
      ...
      <div class="question">
        ...
        <div class="question-answer">
          Download the Software Engineering Daily app for <a
            href="https://itunes.apple.com/us/app/software-engineering-daily-podcast-app/id1253734426?ls=1&mt=8"
            target="_blank"> iOS </a> or <a
              href="https://play.google.com/store/apps/details?id=com.koalatea.thehollidayinn.softwareengineeringdaily"
              target="_blank">Android</a>, or go to softwaredaily.com and login.
        </div>
      </div>
