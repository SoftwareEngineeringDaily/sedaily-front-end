  ...
  <div class="admin-user-list">
    ...
    <div class="users-table">
      ...
      <div class="users-table-header">
        ...
        <div class="table-col size-1 center">Status</div>
      </div>

      <div class="users-table-row" v-for="user in filteredPage" :key="user._id" @click="onClickUser(user)">
        ...
        <div class="table-col size-1 center actions">
          <b-badge v-if="user.isAdmin" variant="active">Admin</b-badge>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    onClickUser (user) {
      this.$router.push({ path: `/admin/user/${user._id}` })
    },
