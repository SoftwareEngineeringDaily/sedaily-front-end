<template>
	<div class="body" :class="{inverse:inverse,featured:featured}" >
		...
		<div class="author">
			<post-meta :post="post" :showDuration="false" :isPreview="isPreview"/>
		</div>
...
<script>
import { PostMeta, PostTopicsList, PostTopics, PostTitle } from '@/components/post'
import VotingArrows from '@/components/VotingArrows'

import { postPrettyUrl } from '@/utils/post.utils'

export default {
	components: { VotingArrows, PostMeta, PostTopicsList, PostTopics, PostTitle },
	props: {
		post: {
	      type: Object,
	      required: true
