<template>
  <div class="topicpage-create">
    <button class="link-button" @click="toggleModal">
      <i class="fa fa-plus" /> Post
    </button>

    <modal v-show="isModalVisible">
      <h4 slot="header">What is the name of your project or company?</h4>
      <template slot="body">
        <p>
          We are always looking for new show ideas to cover in Software Daily.
          Here you can submit a company or project idea.
        </p>
        <b-input
          autocomplete="off"
          :autofocus="true"
